...
struct AeromechanicalModelParameters {
  ...
  double cd_max{3.4};
  double cd_0{0.4};
  double rotational_damping_coefficient{5.0}; // From whitney: This value [5.0], in general, led to the best agreement between measured and predicted passive-rotation trajectories.
