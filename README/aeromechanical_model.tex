...
\end{equation}
where \(t_h = 0.025\,\mathrm{mm}\), \(w_h = 2.7\,\mathrm{mm}\), and \(L_h = 0.10\,\mathrm{m}\) are the thickness, width, and length of the central layer. For Kapton, \(E_h = 2.5\,\mathrm{GPa}\).
