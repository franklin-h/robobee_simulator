...
\subsection{Final Tuning} 
It may be possible that the actual nominal values for all the above parameters may result in hover where the wing doesn't pitch enough to mimic the experiment, doesn't have enough amplitude, etc. 
