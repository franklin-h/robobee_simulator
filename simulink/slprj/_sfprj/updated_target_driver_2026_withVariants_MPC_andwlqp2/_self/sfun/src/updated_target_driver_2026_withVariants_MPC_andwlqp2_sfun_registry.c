  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_updated_target_driver_2026_withVariants_MPC_andwlqp2_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "updated_target_driver_2026_withVariants_MPC_andwlqp2")
      == 0) {
...
{
  extern unsigned int
    sf_updated_target_driver_2026_withVariants_MPC_andwlqp2_jit_fallback_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
...
extern void updated_target_driver_2026_withVariants_MPC_andwlqp2_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    updated_target_driver_2026_withVariants_MPC_andwlqp2_terminator();
  }

  return;
}

extern void updated_target_driver_2026_withVariants_MPC_andwlqp2_initializer
  (void);
...
void sf_machine_global_initializer()
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    updated_target_driver_2026_withVariants_MPC_andwlqp2_initializer();
  }
