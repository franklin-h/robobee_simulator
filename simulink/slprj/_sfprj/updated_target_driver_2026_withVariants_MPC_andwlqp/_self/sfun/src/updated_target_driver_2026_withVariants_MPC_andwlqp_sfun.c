...
void updated_target_driver_2026_withVariants_MPC_andwlqp_initializer(void)
{
}

void updated_target_driver_2026_withVariants_MPC_andwlqp_terminator(void)
{
}

/* SFunction Glue Code */
unsigned int
  sf_updated_target_driver_2026_withVariants_MPC_andwlqp_method_dispatcher
...
unsigned int
  sf_updated_target_driver_2026_withVariants_MPC_andwlqp_process_check_sum_call(
  int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3381052306U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1729229872U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2053971758U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(609318378U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1828401515U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2063374671U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3338382452U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3794622059U);
  }
...
unsigned int
  sf_updated_target_driver_2026_withVariants_MPC_andwlqp_get_eml_resolved_functions_info
  ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...
unsigned int
  sf_updated_target_driver_2026_withVariants_MPC_andwlqp_third_party_uses_info
  ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
unsigned int
  sf_updated_target_driver_2026_withVariants_MPC_andwlqp_jit_fallback_info( int
...
unsigned int
  sf_updated_target_driver_2026_withVariants_MPC_andwlqp_get_post_codegen_info
  ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
unsigned int
  sf_updated_target_driver_2026_withVariants_MPC_andwlqp_updateBuildInfo_args_info
  ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
void
  ...
  (void);
mxArray*
  load_updated_target_driver_2026_withVariants_MPC_andwlqp_optimization_info
  (boolean_T isRtwGen, boolean_T isModelRef, boolean_T isExternal)
{
  ...
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "updated_target_driver_2026_withVariants_MPC_andwlqp",
      "updated_target_driver_2026_withVariants_MPC_andwlqp");
