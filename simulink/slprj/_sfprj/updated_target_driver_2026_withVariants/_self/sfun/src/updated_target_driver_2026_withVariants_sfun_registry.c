...
{
  extern unsigned int
    sf_updated_target_driver_2026_withVariants_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_updated_target_driver_2026_withVariants_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_updated_target_driver_2026_withVariants_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "updated_target_driver_2026_withVariants") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_updated_target_driver_2026_withVariants_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_updated_target_driver_2026_withVariants_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "updated_target_driver_2026_withVariants") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_updated_target_driver_2026_withVariants_jit_fallback_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_updated_target_driver_2026_withVariants_get_post_codegen_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "updated_target_driver_2026_withVariants") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_updated_target_driver_2026_withVariants_get_post_codegen_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_updated_target_driver_2026_withVariants_updateBuildInfo_args_info( int
  ...
  if (strcmp(machineName, "updated_target_driver_2026_withVariants") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_updated_target_driver_2026_withVariants_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int sf_updated_target_driver_2026_withVariants_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"updated_target_driver_2026_withVariants")) {
    return(sf_updated_target_driver_2026_withVariants_method_dispatcher
...
extern void updated_target_driver_2026_withVariants_terminator(void);
void sf_machine_global_terminator(SimStruct* S)
{
  (void)S;
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    updated_target_driver_2026_withVariants_terminator();
  }

  return;
}

extern void updated_target_driver_2026_withVariants_initializer(void);
...
void sf_machine_global_initializer()
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    updated_target_driver_2026_withVariants_initializer();
  }
