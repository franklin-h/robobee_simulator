...
#include "updated_target_driver_2026_withVariants_MPC_sfun.h"
#include "c5_updated_target_driver_2026_withVariants_MPC.h"
...
static emlrtRSInfo c5_emlrtRSI = { 4,  /* lineNo */
  ...
  "#updated_target_driver_2026_withVariants_MPC:1321"/* pathName */
};

/* Function Declarations */
static void initialize_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void initialize_params_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void mdl_start_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void mdl_terminate_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void
  mdl_setup_runtime_resources_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void
  mdl_cleanup_runtime_resources_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void enable_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void disable_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void sf_gateway_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void ext_mode_exec_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
...
static const mxArray
  *get_sim_state_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance);
static void set_sim_state_c5_updated_target_driver_2026_withVariants_MPC
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance,
   const mxArray *c5_st);
  ...
  (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance)
{
  ...
  covrtEmlFcnInitFcn(chartInstance->c5_covrtInstance, 4U, 0U, 0U,
                     "c5_updated_target_driver_2026_withVariants_MPC", 0, -1,
                     363);
...
const mxArray
  *sf_c5_updated_target_driver_2026_withVariants_MPC_get_eml_resolved_functions_info
  (void)
{
...
/* SFunction Glue Code */
void sf_c5_updated_target_driver_2026_withVariants_MPC_get_check_sum(mxArray
  *plhs[])
{
...
mxArray *sf_c5_updated_target_driver_2026_withVariants_MPC_third_party_uses_info
  (void)
{
...
mxArray *sf_c5_updated_target_driver_2026_withVariants_MPC_jit_fallback_info
  (void)
{
...
mxArray
  *sf_c5_updated_target_driver_2026_withVariants_MPC_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c5_updated_target_driver_2026_withVariants_MPC(void)
{
  ...
  sf_c5_updated_target_driver_2026_withVariants_MPC_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_updated_target_driver_2026_withVariants_MPC
  (void *chartInstanceVar)
{
  initialize_params_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct*)
     chartInstanceVar);
  initialize_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c5_updated_target_driver_2026_withVariants_MPC(void
  *chartInstanceVar)
{
  enable_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c5_updated_target_driver_2026_withVariants_MPC
  (void *chartInstanceVar)
{
  disable_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c5_updated_target_driver_2026_withVariants_MPC
  (void *chartInstanceVar)
{
  sf_gateway_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct*)
     chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c5_updated_target_driver_2026_withVariants_MPC
  (SimStruct* S)
{
  return get_sim_state_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *)
     sf_get_chart_instance_ptr(S));    /* raw sim ctx */
}

static void
  sf_opaque_set_sim_state_c5_updated_target_driver_2026_withVariants_MPC
  (SimStruct* S, const mxArray *st)
{
  set_sim_state_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct*)
     sf_get_chart_instance_ptr(S), st);
}

static void
  sf_opaque_cleanup_runtime_resources_c5_updated_target_driver_2026_withVariants_MPC
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      ...
      unload_updated_target_driver_2026_withVariants_MPC_optimization_info();
    }
...
static void sf_opaque_mdl_start_c5_updated_target_driver_2026_withVariants_MPC
  (void *chartInstanceVar)
{
  mdl_start_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct*)
     chartInstanceVar);
  if (chartInstanceVar) {
...
static void
  sf_opaque_mdl_terminate_c5_updated_target_driver_2026_withVariants_MPC(void
  *chartInstanceVar)
{
  mdl_terminate_c5_updated_target_driver_2026_withVariants_MPC
    ((SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_updated_target_driver_2026_withVariants_MPC
  (SimStruct *S)
{
...
const char
  * sf_c5_updated_target_driver_2026_withVariants_MPC_get_post_codegen_info(void)
{
  int i;
  const char* encStrCodegen [26] = {
    "eNrdWUtv41QUdkqamaLpABsYIaQBCSE2TKePGUYCQTt5dIL6CJO0IxWhcGOfxJfY1577SJOuukM",
    "sEBs2LJDY8TNgyU9gzx9ghdggca7jpB43k9iOoBFXcptj57vn/biOkavuG7hu4vXjbcMo4P/reC",
    "0Zw7Uc0rnINbyfNz4M6dqLhmHahMsqa3tG+mV6FnSA1VW7TfspsUy5NcKJKzLwZcSFxyA8R0nqs",
    "XTCU9YGDszEDXyPy1R8BXWVQ1m3opipOYsnNjXtuu0px3qIGxLrkDmD5/H1lawhxxLlYMoKgCVt",
    "7qmOXXFIZ7oVuDwt2mB2hXJT20qArCtfqyr2lSOp70C5D2aVCUnQCmKGvnVJJBRlP3WEUFEfoT3",
    "XdyhhyW1tE1EHH6NDwpFv4d9DJdF6CfkivxZlRHqcEqfsOkUd4QmxNQfl3MewdlLbWbqyBC3V6V",
    "DW0dblygWG+mOcJLBVu+j1gJMOHLKUOai1K/cDB4/jMnkOVnVYZspB5Q69IjJhA77lHlpIZORbM",
    "VmROI5Ih214/h70wAn4l4gkGbBD/inAQlCr4R0TrrMgZSYpRp8qCLFFj1k0uYd7MVRQcA+weCaA",
    "U1eHFFho5rHo441mxaQS0nOLmEalvb2E/C5jq0wCbxMTEtc+TqgAFDiIq5R8LSpIy9FotJIMtEy",
    "8A7DMUEO0FSuderyLNk5bZC9spTMhHRqsDpRAQlAwyhjdx8RRCWV2BVY4HR5HAitWOr6I1fmTCW",
    "wS0wZL9xPqwD4IvYFIXJ+xj+ygtj0qByUQJqd+0kxSAixsJNpKjYEPR6zLvFNW4Z5bDyeCKXEFg",
    "FWDcIZt4SG2JT6ooPDJpObwtKEjK8t45hLpkJaOjV1g2Fm0rroTEhOzqsxwdEOB5sHW6Rm2diao",
    "kDhODcpBDljBPHorl24efSWkN8e5VBUNjp4i2IYZTko7rWDYgwZ1IbhRJzhTDMlwab53jQu+K0v",
    "T+S7hp1xGnDEn7osILj/BPnciuJdD2rzXVMEsZDUl4R2QTQstBLy5cXfjfvOUSjss0qK5Xytelu",
    "9GAj+M5Pv1hXT+Ww3pb4MzAZbtvrwY1C8ywXMx/pnUKYShjR7tYbzo1aZDX9ajxIGm3Erk0ZjQj",
    "/TnoDHUsTFwO5JQTpS4ZIe4vUcrau8R7tEMP92K4TTNvZbXAmhK029iZvjN8JCk93swY79CbL9C",
    "YDWF+TCU53wG/pMYXtOflT9fOxLAxVqbE9bFYmV7ayMhgwONnpTXRkebtefJf8e9sEtUj5dmxMd",
    "qeP/7w0+/nAf/zdlbb8+Dj8bDvPhZcfFqzA+aFjvl9cfvD46Pe9ZZCQYnFbF3dLo73O/dyH65Cf",
    "tF4zPL97PiptW3/KX6ljdyuDRuO4JbNabjCqGNvvp66afX//z976XvPjj/4efzzXnquV9IV79uh",
    "vQbo/PUeOLsXRrKkvj/tZj/NS22dmyA3YNHu1u2KFW75fUT1zwsBvv9sjxd3msxeUf338RL6mqq",
    "9+dm1YqUXKKGZ/Z4vBdm2GPlmXj/4+P58Fvb8XiYZK+VmL00TRzfJk1OrAlxfHX63NtOUsevx/T",
    "RdAtkoM5i6HE/s186xHUXzy/vbM/q87lI7RnqkzckzhKLIf96Ivlzz8ifM/oLY/+NTPIPFkb+zU",
    "zyn8XkX/Tzx1Wdd65SziTnnnxG3DVjvnPWf4WbV79/ez5dtO9nPS8umh7GlPp0Y4Jeudi+i6rXb",
    "0a6+f52SH80fhdftKljTXgbGD7eA9Ke9PR/Et9/pbTf6DxT1vYLf0w82dxhxBkIOnzZMrpd4/p3",
    "rPEjDkRMfsd6FX1o0pwxqc8vx/Jb00eNynsP5uhn/wDdU4Z/",
    ""
  };

  static char newstr [1849] = "";
  newstr[0] = '\0';
  for (i = 0; i < 26; i++) {
...
static void mdlSetWorkWidths_c5_updated_target_driver_2026_withVariants_MPC
  (SimStruct *S)
{
  const char* newstr =
    sf_c5_updated_target_driver_2026_withVariants_MPC_get_post_codegen_info();
...
static void mdlRTW_c5_updated_target_driver_2026_withVariants_MPC(SimStruct *S)
{
...
static void
  mdlSetupRuntimeResources_c5_updated_target_driver_2026_withVariants_MPC
  (SimStruct *S)
{
  SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *chartInstance;
  chartInstance =
    (SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct *)utMalloc
    (sizeof(SFc5_updated_target_driver_2026_withVariants_MPCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.mdlStart =
    sf_opaque_mdl_start_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.mdlTerminate =
    sf_opaque_mdl_terminate_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.mdlCleanupRuntimeResources =
    sf_opaque_cleanup_runtime_resources_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c5_updated_target_driver_2026_withVariants_MPC;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_updated_target_driver_2026_withVariants_MPC;
...
void c5_updated_target_driver_2026_withVariants_MPC_method_dispatcher(SimStruct *
  S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_SETUP_RUNTIME_RESOURCES:
    mdlSetupRuntimeResources_c5_updated_target_driver_2026_withVariants_MPC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_updated_target_driver_2026_withVariants_MPC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_updated_target_driver_2026_withVariants_MPC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_updated_target_driver_2026_withVariants_MPC_method_dispatcher.\n"
